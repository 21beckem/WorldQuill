export default class Cursor {
    ...
    static set(cursor=Cursor.default) {
        if (!(cursor instanceof Cursor)) return;
        this.target.style.cursor = cursor.value;
    }
    static reset() {
...
Cursor.register('default', 'default');
Cursor.register('pointer', 'pointer');
